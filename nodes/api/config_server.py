            ...
            async def update_qing_config(request):
                ...
                try:
                    ...
                    if action == 'update_api_key':
                        ...
                        success = qing_config_manager.update_api_key(api_key, source, config_key)
...
def get_api_key_by_platform(config_key: str) -> str:
    ...
    Args:
        config_key: 配置键名（如: glm_api_key, volcengine_api_key, dashscope_api_key, siliconflow_api_key）
